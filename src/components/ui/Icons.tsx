...
export function BookmarkPlusIcon({ size = 18, className }: IconProps) {
  return (
...
export function FolderNewIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function FolderIcon({ size = 18, className, color = '#5AB1F0' }: IconProps & { color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" className={className}>
      <path d="M2 4.5A1.5 1.5 0 013.5 3h3.293a1 1 0 01.707.293L9.207 5H16.5A1.5 1.5 0 0118 6.5v9a1.5 1.5 0 01-1.5 1.5h-13A1.5 1.5 0 012 15.5v-11z" fill={color}/>
      <path d="M2 7h16v8.5a1.5 1.5 0 01-1.5 1.5h-13A1.5 1.5 0 012 15.5V7z" fill={color} fillOpacity="0.8"/>
    </svg>
  )
}

export const FOLDER_COLORS = [
  { id: 'blue', color: '#5AB1F0', label: 'Blue' },
...
export function GrayIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <rect x="3" y="3" width="18" height="18" rx="4" fill="#494a4c" />
      <circle cx="12" cy="12" r="3" fill="#9a9a9a" />
    </svg>
  )
}
